            ...
            <form method="post" id="form_usuarios">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" onfocusout="algoritmo_cedula();cedula_repetida();" oninput="soloNumeros(event);" required class="form-control" id="Cedula" name="Cedula"  placeholder="Ingrese su Cédula">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" oninput="soloLetras(event);" required class="form-control" id="Nombres" name="Nombres" placeholder="Ingrese sus Nombres">
                    </div>
                    <div class="form-group">
                        <label for="Apellidos">Apellidos</label>
                        <input type="text"  oninput="soloLetras(event);" required class="form-control" id="Apellidos" name="Apellidos" placeholder="Ingrese sus Apellidos">
                    </div>
                    <div class="form-group">
                        <label for="Telefono">Teléfono</label>
                        <input type="text" oninput="soloNumeros(event);" required class="form-control" id="Telefono" name="Telefono" placeholder=" Ingrese su Telefono">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required onfocusout="verifica_correo()" class="form-control" id="Correo" name="Correo" placeholder=" Ingrese su Correo">
                        <div class="alert alert-danger d-none" role="alert" id="CorreoRepetido">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="Contrasenia">Contraseña</label>
                        <input type="password" required onfocusout="verifica_contrasenias()" class="form-control" id="Contrasenia" name="Contrasenia" placeholder=" Ingrese su Contrasenia">
                        <div class="alert alert-danger d-none" role="alert" id="errorContrasenia">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="nombre">Repita su contraseña</label>
                        <input type="password" required class="form-control" onfocusout="verifica_contrasenias()"  id="Contrasenia2" placeholder=" Diguite su Contrasenia">
                        <div class="alert alert-danger d-none" role="alert" id="errorContrasenia">
                        </div>
                    </div>
